...
# or 
# data.loc[(data['sex']=='Male') & (data['rank']=='Prof')].sort_values(by='salary', ascending = [False])[:1]
print(male_professor[male_professor['salary'] == male_professor['salary'].min()])
# or
# data.loc[(data['sex']=='Male') & (data['rank']=='Prof')].sort_values(by='salary', ascending = [True])[:1]
